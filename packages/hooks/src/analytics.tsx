...
import type { APIMessageFull, APIMessageWithDiscordAccount } from "@answeroverflow/api";
...
export function messageWithDiscordAccountToAnalyticsData(
  ...
  return {
    "Channel Id": message.parentChannelId ? message.parentChannelId : message.channelId,
