...
const poppins = Poppins({ subsets: ["latin"], weight: ["400", "500"], variable: "--font-poppins", style: ['normal'] });
// Regular - 400
// Medium  - 500
export function AnswerOverflowLogo() {
  const Svg = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 889.87 240.34" className='stroke-black fill-black dark:stroke-white dark:fill-white w-full'>
      <defs>
      ...
      <g id="TEXT">
        ...
        <path
          ...
          d="M648.59 75.2h6.21v24.49h-6.21z"
        />
      </g>
      <path
