  ...
  return (
    <MessageContext.Provider value={{ message, collapseContent, loadingStyle }}>
      <Blurrer>
        <div
          className={cn(
            `discord-message grow bg-[#E9ECF2] leading-6 dark:bg-[#181B1F] ${showBorders ? 'border-2' : ''
            } border-black/[.13] dark:border-white/[.13] ${fullRounded ? 'rounded-standard' : 'lg:rounded-tl-standard'
            }`,
            className,
          )}
        >
