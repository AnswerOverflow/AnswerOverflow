...
const MessageContext = createContext<{ message: APIMessageWithDiscordAccount } | null>(null);

export function useMessageContext() {
  const context = useContext(MessageContext);
  if (!context) {
    throw new Error("This component must be rendered as a child of Message component");
  }
  return context;
}
