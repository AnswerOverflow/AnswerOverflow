  ...
  return (
    <div className="mx-auto max-w-7xl bg-white py-24 px-6 lg:px-8">
      ...
      <p className="mt-6 max-w-2xl text-xl text-gray-500">
        Choose an affordable plan that &apos s packed with the best features for engaging your
              ...
              <ul role="list" className="mt-6 space-y-6">
                {tier.features.map((feature) => (
                  <li key={feature} className="flex">
                    <CheckIcon className="h-6 w-6 shrink-0 text-indigo-500" aria-hidden="true" />
