...
const HomeFeature = (props: {
	...
	return (
		<div className="rounded-standard flex flex-col items-center justify-center border-2 border-gray-300 px-2 py-4 text-center md:px-20 md:py-10 dark:border-white/[.13]">
