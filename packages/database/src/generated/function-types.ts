...
export const FUNCTION_TYPE_MAP = {
  ...
  "messages.findLatestMessageIdsByChannelIds": "query",
...
export const NAMESPACE_STRUCTURE = {
  ...
  "messages": ["deleteManyMessages","deleteMessage","findLatestMessageIdsByChannelIds","getMessageById","getMessagePageHeaderData","getMessages","getTopQuestionSolversByServerId","getTotalMessageCount","updateEmbedS3Key","updateEmbedStorageId","upsertManyMessages","upsertMessage"],
