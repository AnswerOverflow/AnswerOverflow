...
export const FUNCTION_TYPE_MAP = {
  ...
  "messages.getMessagePageReplies": "query",
...
export const NAMESPACE_STRUCTURE = {
  ...
  "channels": ["deleteChannel","findAllChannelsByServerId","findChannelByDiscordId","findManyChannelsByDiscordIds","getChannelPageData","getChannelPageHeaderData","getChannelPageThreads","updateChannelSettings","upsertChannel"],
  ...
  "messages": ["deleteManyMessages","deleteMessage","getMessageById","getMessagePageHeaderData","getMessagePageReplies","getTopQuestionSolversByServerId","getTotalMessageCount","updateEmbedS3Key","updateEmbedStorageId","upsertManyMessages","upsertMessage"],
  "search": ["getRecentThreads","getServersUserHasPostedIn","getSimilarThreads","getUserById","getUserComments","getUserPosts","publicSearch"],
