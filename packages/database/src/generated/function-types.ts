...
export const NAMESPACE_STRUCTURE = {
  ...
  "channels": ["createManyChannels","deleteChannel","findAllChannelsByServerId","findAllThreadsByParentId","findChannelByDiscordId","findChannelByInviteCode","findChannelsBeforeId","findLatestThreads","findManyChannelsById","getChannelPageData","updateChannel","updateManyChannels","upsertChannelWithSettings","upsertManyChannels"],
