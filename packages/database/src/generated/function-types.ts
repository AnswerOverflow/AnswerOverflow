...
export const NAMESPACE_STRUCTURE = {
  ...
  "counts": [],
  "discord_accounts": ["deleteDiscordAccount","findDiscordAccountsByName","findManyDiscordAccountsByIds","getUserPageHeaderData","getUserPosts","upsertDiscordAccount","upsertManyDiscordAccounts"],
