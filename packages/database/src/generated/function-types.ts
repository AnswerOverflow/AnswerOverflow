...
export const FUNCTION_TYPE_MAP = {
  ...
  "channels.getSitemapThreads": "query",
...
export const NAMESPACE_STRUCTURE = {
  ...
  "channels": ["deleteChannel","findAllChannelsByServerId","findChannelByDiscordId","findChannelSettingsWithIndexingEnabled","findChannelsByDiscordIds","findManyChannelsByDiscordIds","getCommunityPageHeaderData","getServerPageThreads","getSitemapThreads","updateChannelSettings","upsertChannel"],
