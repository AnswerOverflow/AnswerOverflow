...
export const NAMESPACE_STRUCTURE = {
  ...
  "messages": ["deleteManyMessages","deleteMessage","getMessageById","getMessagePageData","getMessagePageHeaderData","getMessagePageReplies","getTopQuestionSolversByServerId","getTotalMessageCount","updateEmbedS3Key","updateEmbedStorageId","upsertManyMessages","upsertMessage"],
