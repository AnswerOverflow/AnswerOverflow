...
export const FUNCTION_TYPE_MAP = {
  ...
  "channels.getServerPageHeaderData": "query",
...
export const NAMESPACE_STRUCTURE = {
  ...
  "channels": ["deleteChannel","findAllChannelsByServerId","findChannelByDiscordId","findChannelSettingsWithIndexingEnabled","findChannelsByDiscordIds","findManyChannelsByDiscordIds","getChannelPageHeaderData","getChannelPageThreads","getServerPageHeaderData","getServerPageThreads","updateChannelSettings","upsertChannel"],
