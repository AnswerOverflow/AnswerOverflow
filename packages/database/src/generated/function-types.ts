...
export const NAMESPACE_STRUCTURE = {
  ...
  "attachments": ["getAttachmentUrl","uploadAttachmentFromUrl","uploadManyAttachmentsFromUrls"],
  "channels": ["createChannel","createManyChannels","deleteChannel","findAllChannelsByServerId","findAllThreadsByParentId","findChannelByDiscordId","findChannelByInviteCode","findChannelsBeforeId","findLatestThreads","findManyChannelsById","getChannelPageData","updateChannel","updateManyChannels","upsertChannelWithSettings","upsertManyChannels"],
  "discord_accounts": ["createDiscordAccount","createManyDiscordAccounts","deleteDiscordAccount","getDiscordAccountById","updateDiscordAccount","updateManyDiscordAccounts","upsertDiscordAccount","upsertManyDiscordAccounts"],
  ...
  "servers": ["createServer","createServerExternal","findManyServersByDiscordId","findManyServersById","getAllServers","getBiggestServers","getBrowseServers","getServerByDiscordId","getServerByDiscordIdWithChannels","getServerByDomain","updateServer","updateServerExternal","upsertServer","upsertServerExternal"],
