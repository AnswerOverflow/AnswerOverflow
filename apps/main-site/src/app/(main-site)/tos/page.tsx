...
export const metadata: Metadata = {
	title: "Terms of Service - Answer Overflow",
	description: "Terms and conditions for using Answer Overflow",
	openGraph: {
		title: "Terms of Service - Answer Overflow",
		description: "Terms and conditions for using Answer Overflow",
	},
			...
			<article className="prose prose-invert max-w-none">
				...
				<ul>
					...
					<li>
						...
						this Agreement) refers to Hedgehog Software LLC, 2108 N ST STE N,
						Sacramento, CA 95816.
					</li>
					<li>
					...
					<li>
						<strong>Website</strong> refers to AnswerOverflow, accessible from{" "}
						<a href="https://www.answeroverflow.com/">
				...
				<p>
					You represent that you are over the age of 18. If You are under 18,
					You must have a parent or guardian be representative of You in order
					to use the service. The company does not permit those under 13 years
					of age to use the Service.
				</p>
				<p>
				...
				<ul>
					<li>
						By email:{" "}
						<a href="mailto:contact@answeroverflow.com">
							contact@answeroverflow.com
						</a>
					</li>
				</ul>
			</article>
