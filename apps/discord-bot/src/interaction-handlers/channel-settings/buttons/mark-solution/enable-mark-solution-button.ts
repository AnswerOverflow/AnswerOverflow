...
export class EnableMarkSolutionButtonHandler extends ChannelSettingButtonHandler {
  public async getInteractionHandler(
    interaction: MessageComponentInteraction<CacheType>,
    // eslint-disable-next-line no-unused-vars
    parsedData: InteractionHandler.ParseResult<this>
  ) {
    return new SetChannelSettingsFlagInteractionHandler(interaction, true, "MARK_SOLUTION_ENABLED");
  }
