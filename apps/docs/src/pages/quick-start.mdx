...
<Callout type="error" emoji="❗">
  Users have to be marked as consenting to publicly display their messages in order for their messages to be shown publicly. You can read more about this in the [displaying messages](/user-settings/displaying-messages) section.
</Callout>
