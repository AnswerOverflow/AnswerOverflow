...
<Callout type="error" emoji="❗">
	This is a destructive action, it will: - Remove all stored messages of your
	account in the server - Not index future messages of your account in the
	server - Not track analytics events of your account in the server
</Callout>
