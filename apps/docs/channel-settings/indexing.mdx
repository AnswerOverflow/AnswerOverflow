...
Indexing occurs roughly ever 6 hours, although this may fluctuate depending on the number of servers Answer Overflow is in. This is to not overload the Discord API and to allow for questions to be solved before they are indexed.
