...
- ### Consider all messages in indexed channels public (default)

This is the default for new servers. All messages posted in indexed channels are considered public and users are able to opt out with the `/manage-account` slash command.
