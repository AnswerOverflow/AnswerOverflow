...
const DISCORD_CLIENT_ID = await askQuestion(
	'Enter your Discord Application ID: ',
);
console.clear();

console.log(
	`Now go to https://discord.com/developers/applications/${DISCORD_CLIENT_ID}/oauth2 and click on 'Reset Secret' to get your Client Secret.`,
);
...
console.log(
	`Now go to https://discord.com/developers/applications/${DISCORD_CLIENT_ID}/bot and click on 'Reset Token' to get your Bot Token.`,
);
